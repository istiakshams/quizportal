  ...
  <div class="footer-wrap">
    <div class="footer-widgets-wrap">
      <div class="footer-widgets col-span-2">
        ...
        <p>The main difference is that the core components from Landwind are open source under the MIT license, whereas
          Tailwind UI is a paid product.</p>
      </div>
    ...
    <div class="footer-copyright">
      {!! getThemeSetting('copyright_text') !!}
      <ul>
        <li>
          <a href="#">
